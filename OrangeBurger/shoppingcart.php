                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            ?>
                            <li><a href="shoppingcart.php" class="active"><i class="fa fa-shopping-cart" style="font-size:20px"></i></a></li>
                        </ul>
    ...
    <div class="basket">
      ...
      <div class="basket-product">
        <div class="item">
          ...
          <h1><strong><span class="item-quantity">4</span> x </strong> Bacon Filled Burger</h1>
            <p><strong>Extra++ Ketchup</strong></p>
          </div>
        </div>
        ...
        <div class="subtotal">104,000</div>
        <div class="remove">
      ...
      <div class="basket-product">
        <div class="item">
          ...
          <div class="product-details">
            <h1><strong><span class="item-quantity">1</span> x </strong> Triple Cheese Burger</h1>
            <p><strong>Extra+ Spicy</strong></p>
          </div>
        </div>
    ...
    <aside>
      <div class="summary">
        ...
        <div class="summary-subtotal">
          ...
          <div class="subtotal-value final-value" id="basket-subtotal">149,000</div>
        ...
        <div class="summary-total">
          ...
          <div class="total-value final-value" id="basket-total">149,000</div>
        </div>
